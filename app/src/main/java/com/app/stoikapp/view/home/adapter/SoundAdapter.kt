...
class SoundAdapter(private val context: Context, private val meditasiList: MutableList<MeditasiSong>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.cardView.setOnClickListener {
            ...
            Navigation.findNavController(it).navigate(com.app.stoikapp.R.id.action_homeFragment_to_musicPlayFragment, bundle)
        }
    }
